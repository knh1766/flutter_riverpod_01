...
import 'package:riverpod_01/todo.dart';
...
class MyApp extends StatelessWidget {
  const MyApp({Key? key}) : super(key: key); // 수정: Key를 올바르게 사용
...
class TodoPage extends ConsumerWidget {
  // 수정: TodoPage를 ConsumerWidget으로 변경
}
// 2. 위젯을 ConsumerWidget으로 만들면 Provider에 접근할 수 있습니다. class TodoPage extends ConsumerWidget {
...
// 6. ref.watch()는 상태값이 변경되는 것을 계속 수신할 때 사용합니다.
